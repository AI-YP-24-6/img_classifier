...
Датасет имеет **33 класса по 1400 изображений в каждом** (1120 трейн / 280 тест)
...
Лучше всего показал себя бустинг: CatBoost для признаков, извлеченных с помощью HOG, LightGBM - для SIFT.
