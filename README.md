...
```
Приложение Streamlit равзернуто по адресу:
```
http://213.171.25.239:8501/
```
Процесс равзертывания подробно описан в секции **Virtual Private Server**.
...
Приложение развертано на VPS от Cloud.ru. 
